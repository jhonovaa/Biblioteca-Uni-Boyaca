...
public class PrestamoDAOImpl implements PrestamoDAO {
    ...
    public boolean registrarPrestamo(Prestamos p) {
        ...
        try (Connection con = Conexion.conectar()) {
            ...
            try (PreparedStatement psP = con.prepareStatement(sqlPrestamo); PreparedStatement psS = con.prepareStatement(sqlStock)) {
    ...
    public boolean finalizarPrestamo(int idPrestamo, Date fechaReal) {
        ...
        try (Connection con = Conexion.conectar()) {
            ...
            try (PreparedStatement psP = con.prepareStatement(sqlUpdateP); PreparedStatement psS = con.prepareStatement(sqlStock)) {
